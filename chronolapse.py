...
class ChronoFrame(chronoFrame):
    ...
    http://lists.wxwidgets.org/pipermail/wxpython-users/2007-October/069666.html
        ...
        #Isen: Changing to Bitmap from EmptyBitmap
...
class WebcamConfigDialog(webcamConfigDialog):
    ...
    def testWebcamPressed(self, event):
        if self.has_cam:
            #>>>TEMPORARY: Everything between these markers was thrown in temporarily, because I don't understand what any of this code is supposed to be doing
...
class WebcamPreviewDialog(webcamPreviewDialog):
    ...
    def callback(self):
        try:
            ...
            #Testing changing this to Image from EmptyImage
